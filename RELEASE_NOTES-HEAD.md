...
HEAD -> dev origin/dev
* 59cd7f0 (2025-10-31) Greg Rundlett: cleanup info about "install" command 
...
* 538fe06 (2025-10-31) Greg Rundlett: strip trailing whitespace 
  - Modified: `src/scripts/meza.py`

* c9f6d6d (2025-10-31) Greg Rundlett: doc getmeza.sh concise version
Fixes Issue [#172](https://github.com/freephile/meza/issues/172)
  - Modified: `src/scripts/getmeza.md`

* 27d5656 (2025-10-31) Greg Rundlett: doc getmeza.sh Verbose version
Addresses Issue [#172](https://github.com/freephile/meza/issues/172)
  - Added: `src/scripts/getmeza.md`

* 45ad0b8 (2025-10-31) GitHub Action: Auto-update CHANGELOG and release notes - Updated CHANGELOG with latest commits
...
## Meza 43.57.1
* d91c7a7 (2025-10-24) Greg Rundlett: Re-enable WatchAnalytics Fixes Issue [#214](https://github.com/freephile/meza/issues/214)
...
* 0faa71c (2025-10-23) Greg Rundlett: Remove undefined 'destroy' command The meza destroy command was a placeholder for undefined functionality.
Fixes Issue [#211](https://github.com/freephile/meza/issues/211)
  - Modified: `src/scripts/meza.py`
...
* 19193c2 (2025-10-23) Greg Rundlett: Add missing newline at end of file 
  - Modified: `manual/meza-cmd/deploy-notify.md`

## Meza 43.53.3
* 8c1e6c6 (2025-10-23) Greg Rundlett: Add doc for deploy-notify playbook and command - Adds manual/meza-cmd/deploy-notify.md
This fixes Issue [#211](https://github.com/freephile/meza/issues/211)
  - Added: `manual/meza-cmd/deploy-notify.md`

## Meza 43.53.2
* 016aacb (2025-10-23) Greg Rundlett: Add autodeployer doc - improve doc for 'debug'
...
## Meza 43.53.1
* 64c1e8e (2025-10-23) Greg Rundlett: Document the maintenance command 
  - Modified: `manual/meza-cmd/index.md`
  - Modified: `manual/meza-cmd/maint.md`
  - Modified: `src/scripts/meza.py`

## Meza 43.52.2
* 43b4eb8 (2025-10-23) Greg Rundlett: Avoid setting shared DB if there is no prime wiki, then there can be no
sharing configured
  - Modified: `src/roles/mediawiki/templates/LocalSettings.php.j2`

## Meza 43.52.1
* 2ab3548 (2025-10-22) Greg Rundlett: Add Backup and Retention Policy Framework meza.py
...
## Meza 43.51.1
* 02d78fc (2025-10-22) Greg Rundlett: Fix first-time deploy error due to Apache missing role: init-controller-config
...
## Meza 43.50.1
* 4a96eef (2025-10-21) Greg Rundlett: Enhance help display using rich markdown rendering 
  - Modified: `src/scripts/meza.py`
...
* 9a2be9a (2025-10-20) Greg Rundlett: Remove trailing whitespace in markdown 
  - Modified: `RELEASE-NOTES.md`
  - Modified: `RELEASE_NOTES-HEAD.md`

## Meza 43.49.3
* 2379a05 (2025-10-20) Greg Rundlett: update RELEASE_NOTES to v43.49.2 
  - Modified: `RELEASE-NOTES.md`
  - Added: `RELEASE_NOTES-HEAD.md`

## Meza 43.49.2
* 29d0b9f (2025-10-20) Greg Rundlett: truncate RELEASE_NOTES 
  - Modified: `RELEASE-NOTES.md`

## Meza 43.49.1
* cb737a5 (2025-10-20) Greg Rundlett: consolidate RELEASE_NOTES into one Fixes Issue [#3](https://github.com/freephile/meza/issues/3)
  - Modified: `RELEASE-NOTES.md`
...
## Meza 43.48.2
* 724467c (2025-10-20) Greg Rundlett: Remove obsolete text files Fixes Issue [#3](https://github.com/freephile/meza/issues/3)
...
## Meza 43.48.1
* b21a3ae (2025-10-20) Greg Rundlett: Feat: migrate help system from txt to markdown Enhanced Documentation Features:
...
## Meza 43.47.1
* 13b0f8d (2025-10-20) Greg Rundlett: Add force for symlink creation `meza create wiki` could fail as late as during the update.php phase of a subsequent deploy because the .smw.json file was not writable in the symlinked config directory.
...
## Meza 43.46.2
* f0acdaf (2025-10-20) Greg Rundlett: Fix ansible syntax problems FQCN (Fully Qualified Collection Names)
...
## Meza 43.46.1
* 3f2f5d9 (2025-10-20) Greg Rundlett: Fix meza migrate-wikis task 'Set Primary wiki when no existing declarative config'
...
## Meza 43.45.1
* 8087fde (2025-10-15) Greg Rundlett: Tag "paths" and "defaults" to run always The 'set-vars' role now includes vars from
- config/paths.yml
- config/defaults.yml
...
## Meza 43.44.2
* ff03f42 (2025-10-15) Greg Rundlett: Update SBOM files Update the generated Software Bill Of Materials (SBOM) files
...
## Meza 43.44.1
* 9114307 (2025-10-15) Greg Rundlett: Fix meza maint run_jobs sudo meza maint run_jobs will run all jobs for all wikis.
...
## Meza 43.43.1
* 091cf90 (2025-10-15) Greg Rundlett: Make CoreExtensions and LocalExtensions robust Make the variable declarations more robust so that --check mode works.
e.g. ansible-playbook /opt/meza/src/playbooks/site.yml --check
  - Modified: `src/roles/mediawiki/tasks/main.yml`

## Meza 43.42.1
* f775e37 (2025-10-15) Greg Rundlett: Add Debian support for ImageMagick and Ghostscript Follow the same pattern of cross-platform compatibility used in the
...
## Meza 43.41.1
* 7dd492a (2025-10-15) Greg Rundlett: Convert to using a declarative approach for wikis You can now declare wiki IDs, names, aliases, and other
...
## Meza 43.40.1
* 6f65408 (2025-09-29) Greg Rundlett: Fix linting issues in init-controller-config - Remove trailing space character in a comment that breaks linting.
...
origin/main
* cbce465 (2025-09-29) Rich Evans: fixes for the refresh-links.sh template These changes are what was required for the /opt/.deploy-meza/refresh-links.sh script to run without errors on my CMTE system.
  - Modified: `src/roles/mediawiki/templates/refresh-links.sh.j2`

origin/fix-44-.smw.json
* c6bbd3c (2025-09-28) Greg Rundlett: Ensure .smw.json ownership and permissions Change the init-controller-config role to have a comment that reflects
...
## Meza 43.39.5
* 3046811 (2025-09-25) Greg Rundlett: Update CHANGELOG and RELEASE_NOTES-HEAD Using the commit-hook actually worked and prevented my local commit
...
## Meza 43.39.4
* 5068855 (2025-09-25) Greg Rundlett: Fix lint errors on essential-vars task file Also add fully qualified collection names (FQCN) to avoid other lint
...
* b65ba2d (2025-09-25) Greg Rundlett: Fixup the test-certbot playbook to use set-vars The test-certbot playbook was broken - referencing an unknown role.
...
## Meza 43.39.1
* ab879a5 (2025-09-25) Greg Rundlett: Setup key variables early; avoid extra-vars We're one step closer to not needing sudo in the deploy command.
...
## Meza 43.38.3
* 7485106 (2025-09-25) Greg Rundlett: Add FIXME comment about CommentStreams not working CommentStreams is not showing any errors, nor functionality in our tests
of Meza 43.x
...
## Meza 43.38.2
* c35a73b (2025-09-25) Greg Rundlett: Add comments to CommentStreams config Meza specifically sets
...
* 4033706 (2025-09-17) Greg Rundlett: Add a new script to update the CHANGELOG updateCHANGELOG.sh simply uses git log --pretty to prepend new git activity into the CHANGELOG The CHANGELOG is a 'raw' version of what is changed.
...
## Meza 43.37.3
* 5e50315 (2025-09-16) Greg Rundlett: Update CONTRIBUTING.md with new details Begin the process of updating the tools and quality controls for
Meza.
  - Modified: `CONTRIBUTING.md`

## Meza 43.37.2
* a23b1bd (2025-09-15) Greg Rundlett: Add comment for extension UrlGetParameters As the name implies, the extension enables you to use and/or display
the "GET" parameters of the requested URL.
https://www.mediawiki.org/wiki/Extension:UrlGetParameters
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.37.1
* f041dc2 (2025-09-15) Greg Rundlett: Add config and UPO for HTML emails by default Allowing HTML email only enables the User Preference Option.
...
## Meza 43.36.2
* 07ebd3d (2025-09-11) Greg Rundlett: Update Meza Core Skins - Delete duplicate MinervaNeue block
- Add comment for Timeless skin
  - Modified: `config/MezaCoreSkins.yml`

## Meza 43.36.1
* eee92a0 (2025-09-11) Greg Rundlett: Ensure the verify-permissions playbook executes Add pre_tasks section to the playbook to load variables via the set-vars role.
...
## Meza 43.35.1
* 138d109 (2025-09-06) Greg Rundlett: Add missing Bundled extensions There were 7 bundled extensions which were in MezaLocalExtensions.yml
...
## Meza 43.34.1
* 7335503 (2025-09-04) Greg Rundlett: Update PageForms to 6.x Switch to using Composer for PageForms to make version constraints
easier to manage.
...
## Meza 43.33.2
* 6b9c376 (2025-08-31) Greg Rundlett: Add additional RELEASE_NOTES file up to HEAD This RELEASE_NOTES can be updated throughout a release cycle until
...
## Meza 43.33.1
* f5159bd (2025-08-31) Greg Rundlett: Add DynamicPageList3 Extension DPL allows for creating lists of pages like you would be able to
...
## Meza 43.32.1
* c0a5192 (2025-08-29) Greg Rundlett: Use MediaWiki REL1_43 and  SMW 6.x With fixes in the latest MediaWiki and SMW 6, everything appears
...
## Meza 43.31.4
* bf35f37 (2025-08-28) Greg Rundlett: Do not ignore errors in memcache installation The PECL installation of the PHP-memcache extension was brute force.
...
* ddac121 (2025-08-28) Greg Rundlett: Use YAML instead of INI in hosts file YAML is preferred for Ansible, and is more suitable for more complex
hosts management.
See Issue [#68](https://github.com/freephile/meza/issues/68)
  - Modified: `src/roles/setup-env/templates/hosts.j2`

## Meza 43.31.3
* 72adcda (2025-08-28) Greg Rundlett: Fix deprecation warning: collections_path Settings variable name is singular, not plural.
...
## Meza 43.31.2
* 190e7f3 (2025-08-28) Greg Rundlett: Fix branch name for Medik skin This repo uses 'master' not 'main' terminology
Fixes #139
  - Modified: `config/MezaCoreSkins.yml`

## Meza 43.31.1
* e7b2ea3 (2025-08-27) Greg Rundlett: Re-enable the Medik Skin By enabling the main branch we should pull in the proper commits for
...
## Meza 43.30.2
* 65bc6c4 (2025-08-27) Greg Rundlett: Regenerate RELEASE_NOTES up to 43.25.11 Use src/scripts/generate-release-notes.sh to
update for additional links formatting and --name-status info.
  - Modified: `RELEASE_NOTES-43.25.11.md`

## Meza 43.30.1
* 53cc748 (2025-08-27) Greg Rundlett: Add script to generate RELEASE NOTES Also update the latest release notes.
  - Modified: `RELEASE_NOTES-43.29.1.md`
  - Added: `src/scripts/generate-release-notes.sh`

## Meza 43.29.2
* 148ea86 (2025-08-26) Greg Rundlett: Add latest RELEASE_NOTES Updated procedure at https://wiki.freephile.org/wiki/RELEASE_NOTES
  - Added: `RELEASE_NOTES-43.29.1.md`

origin/bug/191-maintenance-scripts
* d6310e8 (2025-08-25) Greg Rundlett: Add comment about Issue [#72](https://github.com/freephile/meza/issues/72) (deploy without sudo) 
  - Modified: `src/scripts/getmeza.sh`

* 9802d43 (2025-08-25) Greg Rundlett: Fix maintenance script quoting For Issue [#191](https://github.com/freephile/meza/issues/191)
  - Modified: `src/roles/mediawiki/templates/refresh-links.sh.j2`
  - Modified: `src/roles/verify-wiki/tasks/init-wiki.yml`

* 06c2b55 (2025-08-24) Greg Rundlett: Fix maintenance script quoting + best practices - Use FQCN
- Improve spacing
- Name all tasks
...
* db3fb09 (2025-08-24) Greg Rundlett: Fix maintenance script quoting Here we fix templated shell scripts
For Issue [#191](https://github.com/freephile/meza/issues/191)
...
* 88a74ac (2025-08-24) Greg Rundlett: Fix maintenance script quoting Issue [#191](https://github.com/freephile/meza/issues/191)
  - Modified: `src/playbooks/cleanup-upload-stash.yml`
  - Modified: `src/roles/mediawiki/tasks/cirrus_metastore_upgrade.yml`

* 61b7e63 (2025-08-24) Greg Rundlett: Fixing maintenance script quoting Issue [#191](https://github.com/freephile/meza/issues/191)
  - Modified: `src/scripts/unite-the-wikis.sh`

* e36b806 (2025-08-24) Greg Rundlett: Remove commented task CirrusSearch:Metastore --upgrade Fixed in d0a1ecb3 with new cirrus_metastore_upgrade.yml task
...
* a7bec3e (2025-08-22) Greg Rundlett: Fix most Ansible fatal linting errors; Add requirements.yml - Fixes Issue [#187](https://github.com/freephile/meza/issues/187)
...
## Meza 43.28.3
* 6749c66 (2025-08-22) Greg Rundlett: Adopt standard .yamlint for compatibility The default configuration works better with ansible-lint in our CI
...
## Meza 43.28.2
* 9c8132e (2025-08-22) Greg Rundlett: Fix Fully Qualified Collection Name (FQCN) best practices Just for these files:
...
## Meza 43.28.1
* 68c45e6 (2025-08-22) Greg Rundlett: Default to ansible_env.USER for ansible_user When all plays are executed by the 'Application User' (meza-ansible)
...
## Meza 43.27.3
* 67ff2e2 (2025-08-21) Greg Rundlett: Add pre-commit framework Use the pre-commit framework https://pre-commit.com/
...
## Meza 43.27.2
* 2619b97 (2025-08-21) Greg Rundlett: remove blank space 
  - Modified: `src/scripts/lint-files.sh`
  - Modified: `src/scripts/meza.py`
  - Modified: `src/scripts/shell-functions/linux-user.sh`

## Meza 43.27.1
* b3badfc (2025-08-21) Greg Rundlett: Fix users, groups, file permissions AND linting ---- Key Changes ----
...
## Meza 43.25.14
* d89466b (2025-08-21) Greg Rundlett: Add message about RELEASE_NOTES-43.25.11.md 
  - Modified: `RELEASE-NOTES.md`

## Meza 43.25.13
* e100e37 (2025-08-20) Greg Rundlett: Ensure task names and handler names match Task names should start with an Uppercase letter
...
* 30791ab (2025-08-20) Greg Rundlett: Make task name and handler name match 
  - Modified: `src/roles/elasticsearch/tasks/main.yml`

## Meza 43.25.12
* bf90d10 (2025-08-19) Greg Rundlett: Add release notes for 39.5.0 through 43.25.11 
  - Added: `RELEASE_NOTES-43.25.11.md`

## Meza 43.25.11
* 43be973 (2025-08-17) Greg Rundlett: Make wiki config directory group executable Not sure this should be apache owned, but if meza-ansible
user is going to have any permission to do anything here
then it needs to be group executable
  - Modified: `src/roles/configure-wiki/tasks/main.yml`

## Meza 43.25.10
* 45658c3 (2025-08-17) Greg Rundlett: fix quoting in SMW setupStore shell command 
  - Modified: `src/roles/verify-wiki/tasks/import-wiki-sql.yml`

## Meza 43.25.9
* 8a5fde2 (2025-08-16) Greg Rundlett: Add Admin rights for SMW Allow access to Special:SemanticMediaWiki for Sysops group.
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.25.8
* 4b5df1d (2025-08-16) Greg Rundlett: ignore Python venv and Composer vendor 
  - Modified: `.gitignore`

## Meza 43.26.4
* d0a1ecb (2025-08-16) Greg Rundlett: Add MediaWiki CirrusSearch metastore update and indexing The index template is a conservative mapping covering typical
...
## Meza 43.26.3
* b41853e (2025-08-15) Greg Rundlett: Add retry and backoff to index building New Ansible variables:
...
## Meza 43.26.2
* 22d977a (2025-08-15) Greg Rundlett: yum is now dnf Besides that, fixed Ansible lint errors.
- Find them with:
...
## Meza 43.26.1
* c673468 (2025-08-15) Greg Rundlett: Improve elastic index building; add reindexing - Made per-wiki bootstrap script safer and faster:
...
## Meza 43.25.7
* c32d15e (2025-08-14) Greg Rundlett: Add meza-sbom-stats.txt 
  - Added: `src/scripts/meza-sbom-stats.txt`
  - Deleted: `src/scripts/package-stats.txt`

## Meza 43.25.6
* 7a060f0 (2025-08-14) Greg Rundlett: Add stats file generation - --stats option now generates a file in addition to console output
...
## Meza 43.25.5
* 7a333fb (2025-08-14) Greg Rundlett: Add package-stats.txt 
  - Added: `src/scripts/package-stats.txt`

## Meza 43.25.4
* e85adee (2025-08-14) Greg Rundlett: Add first generated SBOM files 
  - Added: `src/scripts/meza-sbom.cyclonedx.json`
  - Added: `src/scripts/meza-sbom.spdx.json`
  - Added: `src/scripts/meza-sbom.txt`

## Meza 43.25.3
* 10803fb (2025-08-14) Greg Rundlett: update docs for generate-sbom.php The GitHub action is disabled since we do not
track composer.lock or composer.local.json in the repo.
  - Modified: `CHANGELOG`
R088	src/scripts/sbom.md	src/scripts/generate-sbom.md

## Meza 43.25.2
* c4dc2d1 (2025-08-13) Greg Rundlett: Yamllint: truthy values should be one of [false, true] 
...
## Meza 43.25.1
* bc092fb (2025-08-13) Greg Rundlett: Fix invalid workflow generate-sbom - indentation 
  - Modified: `.github/workflows/generate-sbom.yml`

## Meza 43.24.2
* 3a761cc (2025-08-13) Greg Rundlett: Add PEP 8 rule to .editorconfig for Python files 
  - Modified: `.editorconfig`

## Meza 43.24.1
* 66db246 (2025-08-13) Greg Rundlett: Code update to score 9.7 / 10 - Added Module Docstring (C0114)
...
* 86a5ee1 (2025-08-13) Greg Rundlett: Fix Import outside toplevel pylint warnings - Standard library imports come first, alphabetically
...
* 11d074d (2025-08-13) Greg Rundlett: fixed all the C0301 "line too long" warnings Use proper line continuation (indent) for long docstrings
./.venv/bin/pylint src/scripts/meza.py --disable=all --enable=C0301 --score=y
is now scored 10/10
  - Modified: `src/scripts/meza.py`

* 8cb704d (2025-08-13) Greg Rundlett: Use Python 3.6 f-strings - "text {}".format(variable) -> f"text {variable}"
...
* 6876637 (2025-08-13) Greg Rundlett: Agressive Auto PEP 8 formatting reduce long lines
add space around operators
  - Modified: `src/scripts/meza.py`

* 8180736 (2025-08-13) Greg Rundlett: basic AutoPEP8 fixes /home/greg/src/meza/.venv/bin/python -m autopep8 --in-place src/scripts/meza.py
  - Modified: `src/scripts/meza.py`

* 1a9ff04 (2025-08-13) Greg Rundlett: convert tabs to spaces 
  - Modified: `src/scripts/meza.py`

## Meza 43.23.1 origin/sec/phpsecurity-s2083-injection
* 6959b04 (2025-08-07) Greg Rundlett: Slight refactor to put regex into a constant 
...
* b1d3ecc (2025-08-06) Greg Rundlett: remove error suppression and handle disabled shell_exec 
  - Modified: `src/roles/htdocs/files/BackupDownload/download.php`

* bf2521e (2025-08-06) Greg Rundlett: Prevent web access to sensitive content. Prevents possible XSS in Test files which are not meant
...
* 83e1f60 (2025-08-06) Greg Rundlett: Avoid using error suppression operator Using the @ operator to suppress errors can hide important issues. The error handling is already in place, so suppression is unnecessary.
  - Modified: `src/roles/htdocs/files/BackupDownload/download.php`

* 250d2ae (2025-08-06) Greg Rundlett: Strengthen path containment check The current path validation using strpos() could have edge cases.
...
* a6e593b (2025-08-06) Greg Rundlett: Fixed dynamic loading of config - add comment to DownloadTest to keep helper methods  in sync
...
* f520f67 (2025-08-06) Greg Rundlett: Implement a hybrid Test Framework that works with both PHPUnit (MediaWiki standard) when available; and a custom fallback framework. Created a comprehensive test file (DownloadTest.php) that:
...
* d064cb4 (2025-08-06) Greg Rundlett: Prevent directory traversal vulnerability. (Vulnerability found with SonarQube) Key Security Improvements:
...
## Meza 43.22.4
* 4b0511b (2025-08-05) Greg Rundlett: fix YAML lint errors 
  - Modified: `.github/workflows/generate-sbom.yml`

## Meza 43.22.3
* b92c983 (2025-08-05) Greg Rundlett: fix YAML lint errors 
  - Modified: `.github/workflows/generate-sbom.yml`
  - Modified: `src/roles/apache-php/tasks/main.yml`

## Meza 43.22.2
* 0fee59c (2025-08-05) Greg Rundlett: Update README with component logos 
  - Modified: `README.md`
  - Added: `assets/meza_component_logos.png`

## Meza 43.22.1 origin/REL1_43
* bb2f80c (2025-08-05) Greg Rundlett: Update CHANGELOG for REL1_43 
  - Modified: `CHANGELOG`

origin/feature/sbom
* ac1eb9c (2025-08-04) Greg Rundlett: Add the github action workflow This needs to be tested.
  - Added: `.github/workflows/generate-sbom.yml`

* 4f3323f (2025-08-04) Greg Rundlett: Add script to show git (annotated) tags You SHOULD use Git Graph in VsCode, but this script is handy for Release Notes and so on.
  - Added: `src/scripts/showTags.md`
  - Added: `src/scripts/showTags.sh`

* 6152f02 (2025-08-04) Greg Rundlett: spaces to tabs 
  - Modified: `src/scripts/importExtensions.php`
  - Modified: `src/scripts/listCoreExtensions.php`

* 16a93f8 (2025-08-02) Greg Rundlett: convert spaces to tabs per coding standards 
  - Modified: `src/scripts/generate-sbom.php`

* 6abeeac (2025-08-02) Greg Rundlett: Change root package reference to NASA - Updated download location: Changed from https://github.com/enterprisemediawiki/meza to https://github.com/nasa/meza
...
* 5170674 (2025-08-02) Greg Rundlett: Update to include composer.LOCAL.lock Key improvements in this updated version:
...
* 274a8e0 (2025-08-02) Greg Rundlett: initial concept with just composer.json This comprehensive SBOM solution will:
...
* 6593381 (2025-08-01) Greg Rundlett: Create SECURITY policy (#175) * Create SECURITY.md
...
## Meza 43.19.4
* 3588683 (2025-08-01) Greg Rundlett: Add TODO comments 
  - Modified: `src/roles/apache-php/tasks/main.yml`
  - Modified: `src/scripts/getmeza.sh`

## Meza 43.19.3
* bbfc794 (2025-07-31) Greg Rundlett: Turn off Kibana by default 
  - Modified: `config/defaults.yml`

## Meza 43.19.2
* 373275a (2025-07-31) Greg Rundlett: Turn off Certbot by default 
  - Modified: `config/defaults.yml`

## Meza 43.19.1
* 04c9242 (2025-07-31) Greg Rundlett: Add missing composer merge for Abuse Filter May (likely!) fix Issue [#168](https://github.com/freephile/meza/issues/168)
...
* 5be1107 (2025-07-29) Greg Rundlett: Final nitpick changes fixes Issue [#170](https://github.com/freephile/meza/issues/170) 
  - Modified: `.github/ISSUE_TEMPLATE/bug_report.md`
  - Modified: `.github/ISSUE_TEMPLATE/feature_request.md`

* 0263f71 (2025-07-29) Greg Rundlett: Update new issue workflow templates - updates Pull #169
...
* 91a52b1 (2025-07-29) Greg Rundlett: Update issue templates to new workflow See https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests/configuring-issue-templates-for-your-repository
...
* 2a996bd (2025-07-24) Greg Rundlett: DOWNGRADE MediaWiki to 1.43.1 Avoid breaking changes in 1.43.2 which technically should
...
## Meza 43.16.1
* 7d40d3e (2025-07-24) Greg Rundlett: Upgrade ModernTimeline to 2.x Upgrade from 1.x to 2.x
Fixes #167
...
## Meza 43.15.1
* 9aab3a1 (2025-07-23) Greg Rundlett: Enable 'overwrite_local_changes'  for Composer Add composer-installed skins and extensions to the switch for overwriting local changes. This gives parity with Git-controlled extensions and skins.
...
## Meza 43.14.1
* 8a6d493 (2025-07-22) Greg Rundlett: Upgrade Maps from 10.x to 11.x Fixes #166 SMWPrintRequest not found
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.13.3
* 1896a15 (2025-07-10) Greg Rundlett: Fix linting - remove trailing spaces 
  - Modified: `config/MezaCoreExtensions.yml`
  - Modified: `config/MezaCoreSkins.yml`

## Meza 43.13.2
* 869607c (2025-07-09) Greg Rundlett: remove extraneous '1' 
  - Modified: `src/scripts/listCoreExtensions.php`

## Meza 43.13.1
* db2e3b5 (2025-07-09) Greg Rundlett: Disable Who's Online for being problematic 
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.12.1
* 37b9be5 (2025-06-06) Greg Rundlett: Add MW Core bundled extensions Fixes #135
Adds extensions
- AbuseFilter
- DiscussionTools
- Linter
...
## Meza 43.11.2
* 7581e79 (2025-06-06) Greg Rundlett: re-enable Semantic Extensions   SRF and SCQ update Semantic Result Formats
...
## Meza 43.11.1
* 9e3ff55 (2025-06-05) Greg Rundlett: Fix #140 enabling the SemanticDependencyUpdater and SRF SemanticDependencyUpdater and SemanticResultFormats
are the last of the SMW extensions to be re-enabled.
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.10.5
* 35a35c1 (2025-06-05) Greg Rundlett: Fixes #143 elimating duplicates between MezaCoreExtensions and MezaLocalExtensions Adds utility scripts that can be used to list core and diff to local.
...
## Meza 43.10.4
* 41bbcd8 (2025-06-05) Greg Rundlett: Fixes Issue [#62](https://github.com/freephile/meza/issues/62) Url for Netdata install has changed Update the URL, and use sh instead of bash because that is
what the install guide does (hence there are no 'bashisms')
  - Modified: `src/roles/netdata/tasks/main.yml`

## Meza 43.10.3
* 66d7a4b (2025-06-04) Greg Rundlett: specify theme (neutral) for Mermaid extension 
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.10.2
* 6100d3c (2025-06-04) Greg Rundlett: Block WhatLinksHere using Lockdown against robots #156 
  - Modified: `config/MezaCoreExtensions.yml`

* 53dcb43 (2025-06-03) Rich Evans: Update MezaCoreExtensions.yml Set Page Forms Version to the last version that supports MWM 1.39 (tag 5.9.1)
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.10.1
* 7985579 (2025-06-01) Greg Rundlett: Fixes #157 include CommentStreams composer.json in composer.local.json
  - Modified: `config/MezaCoreExtensions.yml`

* 63103b8 (2025-05-15) Greg Rundlett: Add logos of component technologies 
  - Modified: `README.md`

* f37f706 (2024-12-19) Rich Evans: Update haproxy.cfg.j2 removed commented-out obsolete configuration text in haproxy.cfg
  - Modified: `src/roles/haproxy/templates/haproxy.cfg.j2`

* 9a7c999 (2024-12-02) amcgillivray-nasa: Update getmeza.sh Incorporates cowen23's fix for Issue [#57](https://github.com/freephile/meza/issues/57)
  - Modified: `src/scripts/getmeza.sh`

* cf09936 (2025-03-28) Greg Rundlett: Add quotes to version spec for Bootstrap 
  - Modified: `config/MezaCoreExtensions.yml`

* 28a721c (2025-03-26) amcgillivray-nasa: Update MezaCoreExtensions.yml Granted the DeleteBatch permission to sysops (previous configuration did not grant the right to any groups)
  - Modified: `config/MezaCoreExtensions.yml`

* e4ba295 (2025-02-18) Greg Rundlett: make lint command graceful 
  - Modified: `.github/workflows/yamllint.yml`

* a3add76 (2025-02-18) Greg Rundlett: final yamllint fixes 
  - Modified: `config/Debian.yml`
  - Modified: `config/MezaCoreExtensions.yml`
  - Modified: `config/MezaCoreSkins.yml`

* 33cfdf1 (2025-02-18) Greg Rundlett: moved yamllint config 
R100	src/.yamllint	.yamllint

origin/fix-yamllint
* f6ad58e (2025-02-18) Greg Rundlett: Fix yaml files for syntax 
  - Modified: `.github/workflows/yamllint.yml`
  - Modified: `.travis.yml`
  - Modified: `config/Debian.yml`
  - Modified: `config/MezaCoreExtensions.yml`
...
origin/qb-1.43
* fd7ac3a (2025-02-17) Greg Rundlett: Update README with yamllint workflow badge 
  - Modified: `README.md`

* 73c2c0f (2025-02-17) Greg Rundlett: Add multiple branch patterns for the yamllint workflow 
  - Modified: `.github/workflows/yamllint.yml`

* 5c333f5 (2025-02-17) Greg Rundlett: Add new linting workflow 
  - Added: `.github/workflows/yamllint.yml`

## Meza 43.8.1
* 900a1dc (2025-01-28) Greg Rundlett: Switch Mermaid and BootstrapComponents to dev-master Replace deprecated Class loading for \PHPUnit\Framework\TestCase
Fixes Issue [#141](https://github.com/freephile/meza/issues/141)
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.4.7
* 7bc8622 (2025-01-24) Greg Rundlett: Finish off Maintenance Script improvements Last commits for this round of maintenance script operations
...
## Meza 43.7.1
* 7cb9091 (2025-01-24) Greg Rundlett: Add comments for $smwgParserFeatures (Links In Values feature) 
  - Modified: `config/MezaCoreExtensions.yml`

* ab10ebe (2025-01-17) Greg Rundlett: Maintenance Script update (missed these) Convert script calls to go through executable
'maintenance/run'
...
## Meza 43.4.6
* ca17910 (2025-01-17) Greg Rundlett: Finish Maintenance Script update Convert script calls to go through executable
'maintenance/run'
For extensions, use the class naming pattern
'Extension:ClassName'
Fixes Issue [#142](https://github.com/freephile/meza/issues/142)
...
## Meza 43.6.1
* d624f7b (2025-01-16) Greg Rundlett: A new tool to inspect the git repos on the controller 
  - Added: `src/scripts/listExtensionRepos.sh`

## Meza 43.4.5
* e267f14 (2025-01-16) Greg Rundlett: Update the Update.php role for new Maintenance script ops Issue [#142](https://github.com/freephile/meza/issues/142)
  - Modified: `src/roles/update.php/tasks/main.yml`

## Meza 43.4.4
* 9e4de5e (2025-01-16) Greg Rundlett: Update maintenance scripts Server Performance logging/reporting role
(Probably needs to be eliminated altogether)
Issue [#142](https://github.com/freephile/meza/issues/142)
  - Modified: `src/roles/meza-log/templates/server-performance.sh.j2`

## Meza 43.4.3
* 278c394 (2025-01-16) Greg Rundlett: Update maintenance scripts showSiteStats and refreshLinks
Issue [#142](https://github.com/freephile/meza/issues/142)
  - Modified: `src/roles/mediawiki/templates/refresh-links.sh.j2`

## Meza 43.4.2
* 57c9bb2 (2025-01-16) Greg Rundlett: Disable metastore maintenance All maintenance needs to be refactored
Issue [#142](https://github.com/freephile/meza/issues/142)
...
## Meza 43.5.1
* 7ad6676 (2025-01-16) Greg Rundlett: Prefer source in composer managed extensions Use the --prefer-source option to composer
...
## Meza 43.4.1
* f87b92b (2025-01-16) Greg Rundlett: Update maintenance scripts for MediaWiki 1.40 Fixes Issue [#142](https://github.com/freephile/meza/issues/142)
  - Modified: `src/roles/cron/templates/runAllJobs.php.j2`

## Meza 43.3.1
* 4ca775d (2025-01-16) Greg Rundlett: Update MezaCoreExtensions.yml for REL1_43 Use full enableSemantics() call to fix URL pattern
...
## Meza 43.2.1
* e287394 (2025-01-10) Greg Rundlett: Create a variable named php_memory_limit defaulting to 128M PHP normally defaults to 128M so we also default to that.
...
## Meza 43.1.2
* 51c8923 (2025-01-08) Greg Rundlett: Enable SemanticCompoundQueries Was 2.2.0
Now 3.x-dev (same as dev-master)
Issue [#140](https://github.com/freephile/meza/issues/140)
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.1.1
* d2a87e7 (2025-01-08) Greg Rundlett: Use SubPageList dev-master Fixes Issue [#138](https://github.com/freephile/meza/issues/138)
  - Modified: `config/MezaCoreExtensions.yml`

## Meza 43.0.3
* ca17aac (2025-01-07) Greg Rundlett: Disable or update non-working skins These skins need a version adjustment or update
...
## Meza 43.0.2
* cde7d8c (2025-01-07) Greg Rundlett: Disable non-working extensions These extensions do not work, or need a version adjustment,
...
## Meza 43.0.1
* 36567d8 (2025-01-07) Greg Rundlett: Switch SMW to dev-master Addresses Issue [#137](https://github.com/freephile/meza/issues/137)
composer show -a mediawiki/semantic-media-wiki
shows all available composer versions
  - Modified: `config/MezaCoreExtensions.yml`

* a4e8bdf (2024-12-19) Rich Evans: Update haproxy.cfg.j2 removed commented-out obsolete configuration text in haproxy.cfg
  - Modified: `src/roles/haproxy/templates/haproxy.cfg.j2`

* 4f34143 (2024-12-02) amcgillivray-nasa: Update getmeza.sh Incorporates cowen23's fix for Issue [#57](https://github.com/freephile/meza/issues/57)
  - Modified: `src/scripts/getmeza.sh`

* bc3055a (2024-10-13) Rich Evans: Update MezaCoreExtensions.yml Added $wgObjectCacheSessionExpiry to SMW Config and set for 24 hours
  - Modified: `config/MezaCoreExtensions.yml`

* 5857d81 (2024-10-08) amcgillivray-nasa: Update flow configuration in MezaCoreExtensions.yml Configured Flow to use Parsoid
  - Modified: `config/MezaCoreExtensions.yml`

* ba25a5d (2024-10-08) Rich Evans: Update getmeza.sh 1) Don't exclude "ansible" and "ansible core" from epel.repo
2) Don't install of centos-release-ansible-29, and 
3) Don't specify the version of ansible to install.
  - Modified: `src/scripts/getmeza.sh`

* ebcb21c (2024-09-18) Rich Evans: Update MezaCoreExtensions.yml added Extension UrlGetParameters
  - Modified: `config/MezaCoreExtensions.yml`

* d15eabd (2024-09-18) Rich Evans: Update MezaCoreExtensions.yml Update SMW config to not use links in values
  - Modified: `config/MezaCoreExtensions.yml`
