# Ansible Role: Certbot (for Meza)

_This role is a light customization of the **[ansible-role-certbot](https://github.com/geerlingguy/ansible-role-certbot/)** by Jeff Geerling_

Installs and configures Certbot (for Let's Encrypt)

## Requirements

It is integrated for the MediaWiki EZ Administration ([Meza](https://github.com/freephile/meza)) platform and 
specifically its HAProxy TLS termination.
...
This role was created in 2016 by [Jeff Geerling](https://www.jeffgeerling.com/), author of [Ansible for DevOps](https://www.ansiblefordevops.com/), and modified in 2024 to work an updated version of [Meza](https://github.com/freephile/meza) by [Greg Rundlett](https://linkedin.com/in/gregrundlett)
